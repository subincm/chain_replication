...
client_conf = { 'CITI': 
[
  {'index':0, 'account_no': 9999,'client_time_out': 5, 'num_retransmits':3, 'resend_to_new_head':1, 'msg_loss_freq':0},
],}
...
[
    ...
    {'index':1, 'startup_delay': 0, 'rcv_lifetime':1000, 'snd_lifetime':1000, 'ip_addr': '127.0.0.1', 'port': 1002, 'heartbeat_interval':1},
    {'index':2, 'startup_delay': 0, 'rcv_lifetime':5, 'snd_lifetime':5, 'ip_addr': '127.0.0.1', 'port': 1003, 'heartbeat_interval':1}
],}
