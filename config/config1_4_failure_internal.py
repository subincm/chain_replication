...
client_conf = { 'CITI': 
[
  {'index':0, 'account_no': 9999,'client_time_out': 10, 'num_retransmits':3, 'resend_to_new_head':1, 'msg_loss_freq':0},
],}
...
client_prob_conf = [
{'index':0, 'seed':450, 'numReq':15, 'prob':[('getBalance',0.10), ('deposit',0.5), ('withdraw',0.4), ('transfer',0)]}
]
...
[
    ...
    {'index':1, 'startup_delay': 0, 'rcv_lifetime':7, 'snd_lifetime':7, 'ip_addr': '127.0.0.1', 'port': 1002, 'heartbeat_interval':1},
    {'index':2, 'startup_delay': 0, 'rcv_lifetime':5, 'snd_lifetime':5, 'ip_addr': '127.0.0.1', 'port': 1002, 'heartbeat_interval':1},
    {'index':3, 'startup_delay': 0, 'rcv_lifetime':1000, 'snd_lifetime':1000, 'ip_addr': '127.0.0.1', 'port': 1003, 'heartbeat_interval':1}
],}
